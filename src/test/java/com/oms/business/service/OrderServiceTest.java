...
public class OrderServiceTest {
	...
	public void testFindOrderById(){
		OrderDO orderDO = new OrderDO(1002L, 43.23, "Bricks", "Delevered", true, "Order total of 20",
				1234578);
	...
	@Test
	public void create(){
		OrderDO orderDO = new OrderDO(1001L, 33.21, "Bricks", "In Process", false, "Order total of 20",
				4234578);
		
		OrderDataBean orderBean = new OrderDataBean(1001L, 33.21, "Bricks", "In Process", false, "Order total of 8",
				4234578);
